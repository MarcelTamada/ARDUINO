...
Arduino_GFX *tft = new Arduino_ILI9488_18bit(bus, TFT_RST);
...
// posições X
int btn_x[NUM_BUTTONS] = {5, 85, 165, 245, 325, 405,  83, 245,        5, 85, 165, 245, 325, 405,      83, 245};  

// posições Y 
int btn_y[NUM_BUTTONS] = {35, 35, 35, 35, 35, 35,     105, 105,       180, 180, 180, 180, 180, 180,   250, 250};  

// largura
int btn_w[NUM_BUTTONS] = {70, 70, 70, 70, 70, 70,     150, 150,       70, 70, 70, 70, 70, 70,         150, 150};  

// altura
int btn_h[NUM_BUTTONS] = {50, 50, 50, 50, 50, 50,     50, 50,         50, 50, 50, 50, 50, 50,         50, 50};    
...
void paintCircle(int x, int y, int radius) {
  tft->fillCircle(x, y, radius, GREEN); // Pinta um círculo verde
  tft->fillCircle(x, y, radius, BLACK); // Apaga o círculo, retornando à cor de fundo (preto)
}

void simulateTouch(int touch_x, int touch_y) {
  Serial.print("Simulando toque em: ");
  Serial.print(touch_x);
  Serial.print(", ");
  Serial.println(touch_y);

  // Chama a função para pintar o círculo verde na coordenada de toque
  int radius = 10; // Define o raio do círculo para teste de touch
  paintCircle(touch_x, touch_y, radius);
